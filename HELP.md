...
* [Spring Batch](https://docs.spring.io/spring-boot/3.2.12-SNAPSHOT/how-to/batch.html)
* [Spring Security](https://docs.spring.io/spring-boot/3.2.12-SNAPSHOT/reference/web/spring-security.html)
* [OAuth2 Client](https://docs.spring.io/spring-boot/3.2.12-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.client)
